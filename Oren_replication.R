...
if (mode == "run_sim"){
  ...
  saveRDS(cvList, "cvList_rep.rds")
  beep()
} else if (mode == "load"){
  cvList <- readRDS("cvList_rep.rds")
}
...
#required for replication - too computationally expensive
...
if (mode == "run_sim"){
  ...
  saveRDS(bart.dem, "bart.dem_rep.rds")
  beep()
} else if (mode == "load"){
  bart.dem <- readRDS("bart.dem_rep.rds")
}
